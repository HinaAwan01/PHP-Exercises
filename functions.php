...
function calculateArithmeticMean($a,$b,$c){
    ...
    echo "The arithmetic mean of three numbers {$a}, {$b}, and $c is:". ($a+$b+$c)/3;
}
...
function calculateRectangleArea(){
    ...
    global $length, $width;
    echo "Area of the rectangle with length {$length} and width {$width} is ". ($length*$width);
}
...
echo "The area of a triangle with base 2 and height 3 is: ".$area;
